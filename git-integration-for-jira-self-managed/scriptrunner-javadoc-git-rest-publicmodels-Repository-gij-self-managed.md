...
*  *[Object](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html)*  \> [Repository](#)
...
| `public` | [Repository](#repositorygitmanager-integrationtype-boolean)(*com.bigbrassband.jira.git.services.gitmanager.GitManager* repository, *[IntegrationType](/git-integration-for-jira-data-center/scriptrunner-javadoc-git-services-integration-IntegrationType-gij-self-managed)* integrationType, `boolean` isShort) |
