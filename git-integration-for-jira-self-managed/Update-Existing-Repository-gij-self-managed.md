...
| _**method**_ | PUT |
| _**parameters**_ | The Request body is a _JSON_ structure similar to the [Add New Repository API](/git-integration-for-jira-self-managed/add-new-repository/) plus the [id](/git-integration-for-jira-self-managed/add-new-repository#id) parameter: |
...
| _**response**_ | Updates the newly changed parameters to the selected repository. |
