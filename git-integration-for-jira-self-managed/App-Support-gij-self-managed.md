...
The Git Integration for Jira app version **4.28+** currently supports **Jira** **8.12** to **9.17+**!
For Git Integration for Jira app version **5.1+**, it only supports **Jira 10.0** to **10.3**.
