...
| **Java 8** | Q2 2024 | Starting Git Integration for Jira app v5.0, it will no longer support Java 8. We recommend to upgrade to newer versions of Java especially for security reasons. Check your Java version using "java -version" in terminal or command line. |
| _(more to come)_ |     |     |
